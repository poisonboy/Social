...
<article class="position-relative ivu-card     i-work-card my-3   pb-2 " id="{{ $post['pid'] }}">
    {{-- Post Author --}}
    ...
    <section class="content-main order-2 mx-3 position-relative">
        ...
        <div class="content-title d-flex flex-row bd-highlight">
            ...
            @if ($post['stickyState'] == 2)
                <img src="/assets/themes/Social/images/icon-sticky.png" loading="lazy" alt="Group Sticky" class="ms-2">
            @elseif ($post['stickyState'] == 3)
                <img src="/assets/themes/Social/images/icon-sticky.png" loading="lazy" alt="Global Sticky" class="ms-2">
            @endif

            {{-- Digest --}}
            @if ($post['digestState'] == 2)
                <img src="/assets/themes/Social/images/icon-digest.png" loading="lazy" alt="General Digest" class="ms-2">
            @elseif ($post['digestState'] == 3)
                <img src="/assets/themes/Social/images/icon-digest.png" loading="lazy" alt="Senior Digest" class="ms-2">
            @endif
        </div>
