    ...
    <div class="flex-grow-1 ms-3">
        <header class="d-lg-flex">
            <section class="d-flex">
                ...
                @if ($group['recommend'])
                    <img src="/assets/themes/Social/images/icon-recommend.png" loading="lazy" class="list-recommend ms-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Recommend" alt="Recommend">
                @endif
