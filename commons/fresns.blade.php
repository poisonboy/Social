...
<head>
    ...
    <link rel="stylesheet" href="/assets/themes/Social/css/atwho.min.css?v={{ $themeVersion }}">
    <link rel="stylesheet" href="/assets/themes/Social/css/prism.min.css?v={{ $themeVersion }}">
...
<body>
    ...
    <div class="ivu-layout-content i-layout-content i-layout-content-fix-with-header">
            ...
            <div class="i-layout-content-main-page" style="min-height: 890px;display:flex">
                ...
                <main class="  i-layout-content-main-page-view i-layout-content-main-page-view-desktop">
                    ...
                    <div class="alert alert-warning m-3" role="alert">
                        ...
                        <button class="btn btn-primary btn-sm ms-3" type="button" data-bs-toggle="modal" data-bs-target="#fresnsModal" data-type="account" data-scene="renewal" data-post-message-key="fresnsRenewal" data-title="{{ fs_lang('renewal') }}" data-url="{{ fs_api_config('site_public_service') }}">
                            {{ fs_lang('renewal') }}
                        </button>
                    </div>
                    @endif
                ...
                {{-- Sidebar --}}
                <div class="  d-none d-sm-block ivu-col ivu-col-order-2 page-community-extra">
                    {{-- Sidebar --}}
                    <section>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body pt-4 pb-5 text-center">
                    ...
                    <button class="btn btn-success me-3" type="button" data-bs-toggle="modal" data-bs-target="#fresnsModal" data-type="account" data-scene="join" data-post-message-key="fresnsJoin" data-title="{{ fs_lang('accountRegister') }}" data-url="{{ fs_api_config('site_public_service') }}">
    ...
    <script>
        ...
        window.mentionStatus = {
            {
                fs_api_config('mention_status') ? 1 : 0
            }
        };
        window.hashtagStatus = {
            {
                fs_api_config('hashtag_status') ? 1 : 0
            }
        };
        window.hashtagFormat = {
            {
                fs_api_config('hashtag_format')
            }
        };
    ...
    <script src="/assets/themes/Social/js/atwho.min.js?v={{ $themeVersion }}"></script>
